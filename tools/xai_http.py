...
def get_env_value(name: str, default=None):
    ...
    Resolve :func:`hermes_cli.config.get_env_value` at call time so temporary
    monkeypatches during earlier imports/tests do not freeze a stale helper into
    this module for the remainder of the process.
    """
    try:
